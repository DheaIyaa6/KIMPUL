...
class _NewsScreenState extends State<NewsScreen> {
  ...
  List<NewsItem> get _filteredNews {
    return widget.newsItems.where((item) {
      ...
      if (_activeCategory == 'bullish') {
        return item.tagType == 'BULLISH';
      }

      if (_activeCategory == 'technical') {
        return item.tagType == 'ANALISIS' ||
            item.title.contains('Teknikal');
      }
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Cari berita komoditas, pasar, atau The Fed...',
          ...
          if (featuredArticle != null &&
            ...
            InkWell(
              onTap: () =>
                  widget.onOpenNewsDetail(featuredArticle!),
              borderRadius: BorderRadius.circular(16),
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.white,
          ...
          ListView.separated(
            ...
            itemCount:
                regularArticles.take(_loadedCount).length,
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                onTap: () =>
                    widget.onOpenNewsDetail(article),
                borderRadius: BorderRadius.circular(16),
                child: Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
          ...
          if (_loadedCount < regularArticles.length) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed:
                    _isLoadingMore ? null : _handleLoadMore,
